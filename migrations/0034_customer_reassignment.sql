-- =====================================================================
-- 0034 — Reassign Customer/User Between Agents
--
-- Adds:
...
-- murabaha_contracts.agent_id + created_by so the ownership Row-Level
-- Security policies (migration 0032) immediately grant Agent B and revoke
-- Agent A. No policy change is required here.
--
-- Idempotent + auto-applied by db-init on boot. RLS-safe (no-op on D1).
-- =====================================================================
